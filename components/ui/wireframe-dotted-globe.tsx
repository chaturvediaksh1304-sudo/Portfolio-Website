...
export default function RotatingEarth({ width = 800, height = 600, className = "", showHint = true }: RotatingEarthProps) {
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {showHint && (
        <div className="absolute bottom-4 left-4 text-xs text-white/50 px-2 py-1 rounded-md bg-black/40">
